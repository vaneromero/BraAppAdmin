...
import com.bp.braappadmin.comunicacion.chat.adapter.UserAdapter
...
class UsersActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val Archivo2 = "Chat"
        val defaultPrefs2 = Splash.PreferenceHelper2.defaultPreference2(this@UsersActivity)
        defaultPrefs2.entrada = 0
        val prefs2 = Splash.PreferenceHelper2.customPreference2(this, Archivo2)

        val texto1: LinearLayout = findViewById(R.id.conttt)
        val anim1: Animation = AnimationUtils.loadAnimation(this@UsersActivity, R.anim.abajo)
        ...
        userRecyclerView.layoutManager =
            LinearLayoutManager(this@UsersActivity, LinearLayout.VERTICAL, false)
        getUsersList()
    }
    ...
    override fun onBackPressed() {
        super.onBackPressed()
        mediaPlayer!!.stop()
        startActivity(Intent(this@UsersActivity, MenuPrinci::class.java))
        Bungee.zoom(this)
        finish()
    }
}