...
class adaptadorD(var context: Context, items: ArrayList<correol>, var listener: ClickListener) :
RecyclerView.Adapter<adaptadorD.ViewHolder>() {
    private var lastPosition = -1
    var items: ArrayList<correol>? = null
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
           val vista = LayoutInflater.from(context).inflate(R.layout.list_item3,parent,false)
    ...
    class ViewHolder(vista: View, listener: ClickListener) : RecyclerView.ViewHolder(vista),
        ...
        init {
            ...
            respuesta = vista.findViewById(R.id.respueta)
            name1 = vista.findViewById(R.id.name2)
