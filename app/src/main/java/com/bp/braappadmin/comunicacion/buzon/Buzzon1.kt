...
import kotlinx.android.synthetic.main.activity_buzzon1.view.*
...
class Buzzon1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_buzzon1)
        val Archivo1 = "Audio"
        ...
        val texto2: LinearLayout = findViewById(R.id.jsdkjf)
        ...
        Ayuda0012.setOnClickListener {
            ...
            datos.clear()
            setupRecyclerView1()
            swipeRefresh1234567.visibility=View.VISIBLE
            swipeRefresh1234567.setOnRefreshListener {
                soundPool!!.play(carga, prefs1.volum1, prefs1.volum1, 0, 0, 1f)
                datos.clear()
                setupRecyclerView1()
                swipeRefresh1234567.isRefreshing = false
            }
        ...
        databaseReference.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                bgu3d.text = currentUser!!.userName
                when (currentUser!!.sexo) {
                    "Masculino" -> {
                        fotito1g1.setBackgroundResource(R.drawable.businessman)
                    }
                    "Femenino" -> {
                        fotito1g1.setBackgroundResource(R.drawable.businesswoman)
                    }
                    "no" -> {
                        fotito1g1.setBackgroundResource(R.drawable.interrogation)
    ...
    fun setupRecyclerView1() {
        datos.clear()
        db.collection("Correo").whereNotEqualTo("respuesta", "En espera...")
            .get()
            .addOnSuccessListener { result ->
                ...
                for (document in result) {
                    ...
                    lita1 = findViewById(R.id.menuCorreo7)
                    layoutManager = LinearLayoutManager(this, LinearLayout.VERTICAL, false)
                    lita1?.layoutManager = layoutManager  // donde se dibuje el layout
                    adaptador = adaptadorD(this@Buzzon1, datos, object : ClickListener {
                        ...
                        override fun onClick(vista: View, index: Int) {
                            ...
                            databaseReference.addValueEventListener(object : ValueEventListener {
                                ...
                                override fun onDataChange(snapshot: DataSnapshot) {
                                    ...
                                    val currentUser = snapshot.getValue(User::class.java)
                                    alerta4("En espera1...",datos[index].fecha,currentUser!!.userName)
                                }
    ...
    private fun alerta4(tipo:String,fecha:String,nombr3:String) {
        ...
        customDialog.window?.setBackgroundDrawable(ColorDrawable(Color.TRANSPARENT))
            ...
            db.collection("Correo").whereEqualTo("fecha", "$fecha")
                ...
                .addOnSuccessListener { result ->
                    for (document in result) {
                        ...
                        customDialog.respuesta.setText("${document.get("respuesta")}")
            ...
            customDialog.saveButto443.setOnClickListener {
                if (customDialog.respuesta.text.isEmpty()) {
                    ...
                    val accion="Editó Respuesta en Comunidad."
...
fun recargar(){
    ...
    override fun onBackPressed() {
        super.onBackPressed()
        mediaPlayer!!.stop()
        startActivity(Intent(this@Buzzon1, MenuPrinci::class.java))
        Bungee.zoom(this)
        finish()
    }
