...
class adaptadorC(var context: Context, items: ArrayList<linkI>, var listener: ClickListener) :
RecyclerView.Adapter<adaptadorC.ViewHolder>() {
    private var lastPosition = -1
    var items: ArrayList<linkI>? = null
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
           val vista = LayoutInflater.from(context).inflate(R.layout.list_item5,parent,false)
    ...
    class ViewHolder(vista: View, listener: ClickListener) : RecyclerView.ViewHolder(vista),
        ...
        init {
            image = vista.findViewById(R.id.imagd)
            nombre = vista.findViewById(R.id.name2)
